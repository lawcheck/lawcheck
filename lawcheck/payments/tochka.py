...
# Отпечаток «Russian Trusted Root CA» (действителен до 27.02.2032). Сверяем на
# старте: подменённый в образе корень — это доверие к чужому УЦ, и заметить
# такое по логам нечем.
